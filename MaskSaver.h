...
//! сериализаци¤ маски в двоичный массив
class CMaskSaver  
{
	//! размер маски
	CRect			m_rcArea;

	//! 2x мерный массив (дл¤ 32 слоев)
	std::vector< std::vector< DWORD > >			m_MaskDump32;
	//! битовый 2х мерный массив (дл¤ 8 слоев)
...
public:
	...
	try
	{
		...
		//ѕроверить какие первый 4 байта
